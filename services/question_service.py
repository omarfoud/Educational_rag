    ...
    def _quiz_difficulty_rules(self, difficulty: DifficultyLevel) -> str:
        ...
        if difficulty == DifficultyLevel.HARD:
            return (
                ...
                "- Prefer problem-solving questions over pure theory when the subject supports calculations, laws, formulas, diagrams, code, or applied scenarios.\n"
                "- For science/math/engineering content, include numerical or scenario-based problems that require applying formulas or rules from the material.\n"
                "- If the material explains a formula or rule but gives no numbers, invent small realistic numbers and ask the student to apply that formula/rule.\n"
